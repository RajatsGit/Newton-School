...
Return an integer in StringToInt() while return a integer in IntToString(). The driver code will print "Nice Job" if your code is correct otherwise "Wrong answer".
